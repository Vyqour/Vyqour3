    ...
    const products = [
        {
            ...
            description: 'Ultra-soft 240 GSM cotton tee with a boxy luxury fit. Minimal VYQOUR mark at the chest. Built for everyday identity.',
        },
        {
            ...
            description: 'Dropped shoulder oversized tee with subtle neon pulse graphic. Statement without noise.',
        },
        {
            ...
            sizes: ['S', 'M', 'L', 'XL', 'XXL'],
            tags: ['hoodie', 'winter'],
            description: '450 GSM French terry hoodie with brushed interior. Deep kangaroo pocket, matte metal tips, embroidered identity mark.',
        },
        {
        ...
        },
        {
            ...
            description: 'Lightweight bomber with satin sheen and ribbed cuffs. Night-ready silhouette for the city.',
        },
        {
    ...
    for (const p of products) {
        ...
        const product = await prisma.product.create({
            data: {
                ...
                variants: {
                    create: p.colors.flatMap((color) => p.sizes.map((size) => {
